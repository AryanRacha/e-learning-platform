...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateCourseDuration,calculateChapterTime,calculateNumberOfLectures,currency} = useContext(AppContext)
  ...
  return courseData?(
      <>
      <div className="flex md:flex-row flex-col flex-col-reverse gap-10 relative items-start justify-between
      md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
            ...
            <div className="flex">
              {[...Array(5)].map((_,i) => (
              <img className="w-3.5 h-3.5" key={i} src={(i< Math.floor(calculateRating(courseData)))?assets.star:assets.star_blank} />)
              )}
            </div>
          ...
          <p className="text-sm">Course by <span className="text-blue-600 underline">Adam Smith</span></p>
                  ...
                  <div className="flex items-center justify-between px-4 py-3 cursor-pointer select-none"
                   onClick={() => toggleSection(index)}>
                    <div className="flex items-center gap-2">
                      ...
                      }`} src={assets.down_arrow_icon} alt="drop down arrow" />
