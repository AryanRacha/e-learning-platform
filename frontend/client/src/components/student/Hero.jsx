...
const Hero = () => {
    return(
      ...
      text-center bg-gradient-to-b from-cyan-100/70">
        ...
        Empower your future with courses designed <span className="text-blue-600">for tomorrow's needs</span>
        <img src={assets.sketch} alt="a sketch" className="md:block hidden absolute -bottom-7 right-0" />
        </h1>
